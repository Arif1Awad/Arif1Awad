...
Each task folder carries its own README explaining what was done at that stage, what every file in it is, and how to re-run it:

| Folder | README | Covers |
|---|---|---|
| `stc TV_T1/` | [stc TV_T1/README.md](stc%20TV_T1/README.md) | Cleaning decisions, feature engineering, diagnostics, the three models, UBA watchlist |
| `stc TV_T1/outputs/` | [stc TV_T1/outputs/README.md](stc%20TV_T1/outputs/README.md) | Data dictionary for all 27 numbered tables + churn scores, user segments and the Excel report |
| `stc_TV_T2/` | [stc_TV_T2/README.md](stc_TV_T2/README.md) | Peak-day method, the 12-week forecast window decision, 60-day projection |
| `stc TV_T3/` | [stc TV_T3/README.md](stc%20TV_T3/README.md) | Interaction matrix, both CF models, hold-out evaluation, Moana answer, cold-start limits |
